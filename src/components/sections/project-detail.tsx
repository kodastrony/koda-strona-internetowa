    ...
    <article>
              ...
              <div className="relative" style={{ paddingBottom: "58%" }}>
                ...
                <div
                  ...
                  style={{
                    ...
                    left: "15%",
                    borderRadius: "50%",
                    background: `radial-gradient(ellipse at center, rgba(${project.rgb},0.24) 0%, rgba(${project.rgb},0.08) 40%, transparent 72%)`,
                  }}
                />
                {project.image ? (
                  <Image
      ...
      >
        ...
        <div className="container-koda section-y relative z-10">
          ...
          <FadeUp inView>
            <div
              className="grid grid-cols-1 gap-8 border-b pb-[clamp(32px,4vw,56px)] sm:grid-cols-3"
            ...
            >
              {[
                ...
                <div key={f.k}>
                  <p
                    className="font-heading text-[11px] font-bold tracking-[0.2em] uppercase"
        ...
        >
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            >
              ...
              <p
                className="mt-2 font-heading font-semibold transition-colors duration-300 group-hover:text-pink"
                style={{
                  fontSize: "clamp(1.2rem,1.8vw,1.6rem)",
                  color: "var(--color-ink)",
                  letterSpacing: "-0.02em",
