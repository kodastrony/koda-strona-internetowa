            ...
            <FadeUp inView key={a.slug} delay={0.05 * i} y={22}>
              <Link
                ...
                style={{
                  ...
                  paddingBottom: "clamp(28px,3.4vw,44px)",
                }}
              >
                <div className="flex flex-wrap items-center gap-3 font-heading text-[11px] font-bold tracking-[0.16em] uppercase">
                ...
                <span className="mt-5 inline-flex items-center gap-2 font-heading text-[12px] font-bold tracking-[0.16em] text-[var(--color-ink-faint)] uppercase transition-colors duration-300 group-hover:text-pink">
                  Czytaj artykuł
                  <span
                    aria-hidden="true"
