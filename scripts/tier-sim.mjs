...
function classifyCurrent(r) {
  ...
  if (r.eff === "3g") cap(1);
  if (r.coarse) {
    if (r.width < 768) cap(1);
    else if (r.width < 1024) cap(2);
  }
...
function classifyNew(r) {
  ...
  // 2. iOS / iPadOS (cores zignorowane — clamp 2). Telefon → LITE (low): bez świtu-
  //    WebGL/scruba (poster + natywny scroll = szybciej, chłodniej, bez baterii).
  ...
  if (memKnown) {
    if (r.mem <= 3) cap(1);
    else if (r.mem <= 4) cap(2);
  }
  if (r.eff === "3g") cap(1);
  if (r.coarse) {
    if (r.width < 768) cap(1);
    else cap(2);
  } // telefon → low (poster), tablet → medium
...
const CASES = [
  ...
  [
    ...
    R({
      ...
      dpr: 1,
      width: 1366,
      renderer: "ANGLE (Intel, Intel(R) UHD Graphics 600 ...)",
    }),
  ],
  [
    "T6 iPhone (cores2,mem-1)",
    "low",
    R({
      cores: 2,
      mem: null,
  ...
  [
    "T7 Brave strong PC farble cores2",
    "medium",
    R({ cores: 2, mem: null, dpr: 1, width: 2560, isBrave: true, renderer: "" }),
  ],
  [
    "T8 iPhone16Pro",
    "low",
  ...
  [
    "T13 MBA M1 Safari",
    "high",
    R({ cores: 8, mem: null, dpr: 2, width: 1280, renderer: "Apple GPU" }),
  ],
  [
    "T14 MBA M2 Chrome",
    "high",
  ...
  [
    "T15 MBP M3Pro",
    "high",
    R({ cores: 12, mem: null, dpr: 2, width: 1512, renderer: "Apple GPU" }),
  ],
  [
    "T16 iMac M1 4K",
    "high",
    R({ cores: 8, mem: null, dpr: 2, width: 1920, renderer: "Apple GPU" }),
  ],
  [
    "T17 RTX3060",
    "high",
  ...
  [
    ...
    R({
      ...
      dpr: 1.5,
      width: 1280,
      renderer: "ANGLE (NVIDIA, NVIDIA GeForce RTX 3050)",
    }),
  ],
  [
    "T19 i5-8250U UHD620",
  ...
  [
    "T20 i5-6200U HD520 FF masked",
    "low",
    R({ cores: 4, mem: null, dpr: 1, width: 1366, isFirefox: true, renderer: "" }),
  ],
  [
    "T21 i3 HD4400",
    "low",
    R({
      ...
      dpr: 1,
      width: 1366,
      renderer: "ANGLE (Intel, Intel(R) HD Graphics 4400)",
    }),
  ],
  [
    "T22 Iris Xe",
  ...
  [
    "T23 Vega7 5500U",
    ["high", "medium"],
    R({ cores: 12, mem: 8, dpr: 1, width: 1536, renderer: "ANGLE (AMD, AMD Radeon(TM) Graphics)" }),
  ],
  [
    "T24 4K GTX1650",
    ["medium", "high"],
  ...
  [
    "T26 Chromebook Mali-G52",
    "low",
    R({ cores: 8, mem: 4, dpr: 1.6, width: 1366, renderer: "Mali-G52" }),
  ],
  [
    "T27 Brave RTX4070 readable cores4",
    "high",
    R({
      cores: 4,
      mem: null,
  ...
  [
    "T28 Brave RTX4070 masked cores2",
    "medium",
    R({ cores: 2, mem: null, dpr: 1, width: 2560, isBrave: true, renderer: "" }),
  ],
  // T29 override = poza classify (priorytet w readOverride)
  [
    "T30 GalaxyS24 Adreno750",
    "low",
    R({ cores: 8, mem: 8, dpr: 3, width: 360, coarse: true, renderer: "Adreno (TM) 750" }),
  ],
  [
    "T31 GalaxyA14 Mali-G52",
    "low",
    R({ cores: 8, mem: 4, dpr: 2.75, width: 360, coarse: true, renderer: "Mali-G52" }),
  ],
  [
    "T32 RedmiN13 Adreno610",
    "low",
    R({ cores: 8, mem: 4, dpr: 2.75, width: 393, coarse: true, renderer: "Adreno (TM) 610" }),
  ],
  [
    "T33 Pixel8 TensorG3",
    "low",
    R({ cores: 9, mem: 8, dpr: 2.625, width: 412, coarse: true, renderer: "Mali-G715" }),
  ],
  [
    "T34 Android saveData",
    "static",
    R({ cores: 8, mem: 2, dpr: 1.5, width: 360, coarse: true, saveData: true }),
  ],
  [
    "T35 Android Firefox",
    "low",
    R({ cores: 8, mem: null, dpr: 2.75, width: 393, coarse: true, isFirefox: true, renderer: "" }),
  ],
  [
    "T36 Android FF+RFP cores2",
    "low",
    R({ cores: 2, mem: null, dpr: 2.75, width: 393, coarse: true, isFirefox: true, renderer: "" }),
  ],
  [
    "T37 TabS9 Adreno740",
    "medium",
    R({ cores: 8, mem: 8, dpr: 2, width: 800, coarse: true, renderer: "Adreno (TM) 740" }),
  ],
  [
    "T38 TabA9+ Adreno619",
    "low",
    R({ cores: 8, mem: 4, dpr: 2, width: 800, coarse: true, renderer: "Adreno (TM) 619" }),
  ],
  [
    "T39 FireHD10 Mali-G52",
    "low",
    R({ cores: 8, mem: 4, dpr: 1.5, width: 800, coarse: true, renderer: "Mali-G52" }),
  ],
  [
    "T40 LenovoP12 Mali-G68",
    "medium",
    R({ cores: 8, mem: 8, dpr: 2, width: 960, coarse: true, renderer: "Mali-G68" }),
  ],
  [
    "T41 Surface mysz Iris Xe",
    "medium",
    R({
      cores: 8,
      mem: 8,
  ...
  [
    "T42 Laptop dotykowy RTX5060 Brave (coarse)",
    "high",
    R({
      cores: 23,
      mem: null,
      ...
      coarse: true,
      isBrave: true,
      renderer: "ANGLE (NVIDIA, NVIDIA GeForce RTX 5060 Laptop GPU (0x00002D59) Direct3D11)",
    }),
  ],
  [
    "T43 Laptop dotykowy RTX Chrome (coarse)",
    "high",
    R({
      cores: 16,
      mem: 16,
      ...
      width: 1920,
      coarse: true,
      renderer: "ANGLE (NVIDIA, NVIDIA GeForce RTX 4060 Laptop GPU)",
    }),
  ],
  // Szare strefy biurowe (z detect-gpu fps): Vega APU, MX/GT, UHD 7xx, stary Intel Mac.
  [
    "T44 Ryzen Vega7 APU (Radeon(TM) Graphics)",
    "medium",
    R({
      cores: 12,
      mem: 8,
  ...
  [
    ...
    R({
      ...
      dpr: 1,
      width: 1920,
      renderer: "ANGLE (NVIDIA, NVIDIA GeForce MX150 Direct3D11)",
    }),
  ],
  [
    "T46 Intel UHD 770 (nowszy biurowy)",
    "medium",
    R({
      cores: 12,
      mem: 16,
      dpr: 1,
      width: 1920,
      renderer: "ANGLE (Intel, Intel(R) UHD Graphics 770 Direct3D11)",
    }),
  ],
  [
    "T47 UHD 620 (stary biurowy) NIE-medium",
    "low",
    R({
      cores: 8,
      mem: 8,
  ...
  [
    "T48 Stary Intel MacBook Air Safari (cores4)",
    "low",
    R({ cores: 4, mem: null, dpr: 2, width: 1440, renderer: "Apple GPU" }),
  ],
  ...
  [
    ...
    R({
      ...
      dpr: 1,
      width: 2560,
      renderer: "ANGLE (AMD, AMD Radeon RX 6600 Direct3D11)",
    }),
  ],
  [
    "T54 Iris Plus G7 → low",
    "low",
    R({
      cores: 8,
      mem: 8,
      dpr: 1,
      width: 1920,
      renderer: "ANGLE (Intel, Intel(R) Iris(R) Plus Graphics)",
    }),
  ],
  [
    "T55 Radeon 680M → high",
    "high",
    R({
      cores: 16,
      mem: 16,
      dpr: 1,
      width: 1920,
      renderer: "ANGLE (AMD, AMD Radeon 680M Direct3D11)",
    }),
  ],
];
...
function runCases(classify, label) {
  ...
  for (const [name, exp, r] of CASES) {
    ...
    if (ok) pass++;
      ...
      fails.push(
        `   ✗ ${name}: oczekiwany ${Array.isArray(exp) ? exp.join("|") : exp}, dostał ${got}`
      );
  }
...
function applyBrowser(browser, dev) {
  ...
  if (browser === "safari") {
    ...
    r.eff = null;
    r.saveData = false;
    r.cores = Math.min(t.cores, 8);
    r.renderer = "Apple GPU";
  } else if (browser === "firefox") {
    r.mem = null;
    r.eff = null;
    r.cores = Math.min(t.cores, 16);
    r.isFirefox = true;
    r.renderer = "";
    ...
    r.cores = 4;
    r.mem = null;
    r.renderer = t.gpu || ""; // Standard: renderer realny
  }
...
function evalDevices(classify, devices, label) {
  ...
  for (const m of misses)
    console.log(
      `   ✗ ${m.name} [${m.browser}]: oczek. ${m.expected}, dostał ${m.got} (${m.diff > 0 ? "ZA WYSOKO" : "ZA NISKO"})`
    );
...
function sweep(classify, label) {
  ...
  let n = 0;
  for (const cores of coresA)
    for (const mem of memA)
      for (const dpr of dprA)
        for (const width of widthA)
          for (const coarse of coarseA) {
            dist[
              classify(
                R({
                  cores,
...
const OFFICE_DEVICES = [
  ...
  {
    name: "Dell Latitude 5490 i5-8250U UHD620",
    klasa: "laptop",
    os: "Windows",
    browser: "chrome",
    expected: "low",
  ...
  {
    name: "Lenovo ThinkPad i5-10210U UHD",
    klasa: "laptop",
    os: "Windows",
    browser: "chrome",
    expected: "low",
    t: {
      ...
      width: 1920,
      coarse: false,
      gpu: "ANGLE (Intel, Intel(R) UHD Graphics Direct3D11 vs_5_0 ps_5_0)",
    },
  },
  {
    name: "HP ProBook i5-1135G7 Iris Xe",
    klasa: "laptop",
    os: "Windows",
    browser: "edge",
    expected: "medium",
  ...
  {
    name: "Dell Latitude i7-1165G7 Iris Xe",
    klasa: "laptop",
    os: "Windows",
    browser: "chrome",
    expected: "medium",
  ...
  {
    name: "HP EliteBook i5-8350U UHD620 HiDPI",
    klasa: "laptop",
    os: "Windows",
    browser: "chrome",
    expected: "low",
  ...
  {
    name: "ThinkPad i5-6300U HD520 (Firefox)",
    klasa: "laptop",
    os: "Windows",
    browser: "firefox",
    expected: "low",
    t: {
      ...
      width: 1366,
      coarse: false,
      gpu: "ANGLE (Intel, Intel(R) HD Graphics 520)",
    },
  },
  {
    name: "Stary i3-7100U HD620 4GB",
    klasa: "laptop",
    os: "Windows",
    browser: "chrome",
    expected: "low",
    t: {
      ...
      width: 1366,
      coarse: false,
      gpu: "ANGLE (Intel, Intel(R) HD Graphics 620 Direct3D11 vs_5_0 ps_5_0)",
    },
  },
  {
    name: "Budżet Celeron N4020 UHD600 4GB",
    klasa: "laptop",
    os: "Windows",
    browser: "chrome",
    expected: "low",
    t: {
      ...
      width: 1366,
      coarse: false,
      gpu: "ANGLE (Intel, Intel(R) UHD Graphics 600 Direct3D11 vs_5_0 ps_5_0)",
    },
  },
  {
    name: "HP Ryzen5 5500U Vega7",
    klasa: "laptop",
    os: "Windows",
    browser: "chrome",
    expected: "medium",
    t: {
      ...
      width: 1920,
      coarse: false,
      gpu: "ANGLE (AMD, AMD Radeon(TM) Graphics Direct3D11 vs_5_0 ps_5_0)",
    },
  },
  {
    name: "2-in-1 dotykowy i5-1135G7 Iris Xe (coarse)",
    klasa: "laptop",
    os: "Windows",
    browser: "edge",
    expected: "medium",
  ...
  {
    name: "Laptop i5-8250U + GeForce MX150",
    klasa: "laptop",
    os: "Windows",
    browser: "chrome",
    expected: "medium",
    t: {
      ...
      width: 1920,
      coarse: false,
      gpu: "ANGLE (NVIDIA, NVIDIA GeForce MX150 Direct3D11 vs_5_0 ps_5_0)",
    },
  },
  // Desktopy biurowe (integrated)
  {
    name: "Desktop i5-7500 HD630",
    klasa: "desktop",
    os: "Windows",
    browser: "chrome",
    expected: "low",
    t: {
      ...
      width: 1920,
      coarse: false,
      gpu: "ANGLE (Intel, Intel(R) HD Graphics 630 Direct3D11 vs_5_0 ps_5_0)",
    },
  },
  {
    name: "Desktop i3-10100 UHD630",
    klasa: "desktop",
    os: "Windows",
    browser: "chrome",
    expected: "low",
    t: {
      ...
      width: 1920,
      coarse: false,
      gpu: "ANGLE (Intel, Intel(R) UHD Graphics 630 Direct3D11 vs_5_0 ps_5_0)",
    },
  },
  {
    name: "Desktop i5-12400 UHD770 (nowszy biurowy)",
    klasa: "desktop",
    os: "Windows",
    browser: "chrome",
    expected: "medium",
    t: {
      ...
      width: 1920,
      coarse: false,
      gpu: "ANGLE (Intel, Intel(R) UHD Graphics 770 Direct3D11 vs_5_0 ps_5_0)",
    },
  },
  {
    name: "Desktop i5-9500 UHD630 @1440p",
    klasa: "desktop",
    os: "Windows",
    browser: "edge",
    expected: "low",
  ...
  {
    name: "Samsung Galaxy S10 Mali-G76 (przegrzewa)",
    klasa: "phone",
    os: "Android",
    browser: "samsung",
    expected: "low",
    t: { cores: 8, mem: 8, dpr: 4, width: 360, coarse: true, gpu: "Mali-G76" },
  },
  {
    name: "Samsung Galaxy A54 Mali-G68",
    klasa: "phone",
    os: "Android",
    browser: "chrome",
    expected: "low",
    t: { cores: 8, mem: 8, dpr: 2.625, width: 360, coarse: true, gpu: "Mali-G68" },
  },
  {
    name: "Samsung Galaxy A14 Mali-G52 4GB",
    klasa: "phone",
    os: "Android",
    browser: "chrome",
    expected: "low",
    t: { cores: 8, mem: 4, dpr: 2.75, width: 360, coarse: true, gpu: "Mali-G52" },
  },
  {
    name: "iPhone 11 A13 (iOS Safari)",
    klasa: "phone",
    os: "iOS",
    browser: "safari",
    expected: "low",
    t: { cores: 6, mem: -1, dpr: 2, width: 414, coarse: true, gpu: "Apple GPU" },
  },
  {
    name: "iPhone SE 2020 A13 (iOS Safari)",
    klasa: "phone",
    os: "iOS",
    browser: "safari",
    expected: "low",
    t: { cores: 6, mem: -1, dpr: 2, width: 375, coarse: true, gpu: "Apple GPU" },
  },
  {
    name: "Stary Intel MacBook Air i5 IrisPlus (Safari)",
    klasa: "laptop",
    os: "macOS",
    browser: "safari",
    expected: "low",
    t: { cores: 4, mem: -1, dpr: 2, width: 1440, coarse: false, gpu: "Intel Iris Plus" },
  },
];
...
try {
  devices = JSON.parse(
    fs.readFileSync(
      "C:/Users/Natan/Desktop/Claude Coding/MAIN KODA/koda-site/scripts/devices.json",
      "utf8"
    )
  );
} catch {
  console.log("(brak devices.json — pomijam bazę)");
}
